...
7.  Type `git remote add upstream https://github.com/codefellows/seattle-301d10.git` to enable quick access to future updates.
...
6.  `cd my-forked-labs`
7.  Back here on GitHub, head to the separate GitHub site where all lab assignments can be found: https://github.com/codefellows-seattle-301d10
